...
document.querySelector(".tic-tak").addEventListener("click", function () {
  window.location.href = 'tic-tac.html';
});
document.querySelector(".brain").addEventListener("click", function () {
  window.location.href = 'brain.html';
});
document.querySelector(".snack").addEventListener("click", function () {
  window.location.href = 'snack.html';
});
document.querySelector(".rock-paper").addEventListener("click", function () {
